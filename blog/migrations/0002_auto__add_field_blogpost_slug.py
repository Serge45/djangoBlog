...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_blogpost', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 8, 28, 0, 0), unique=True, max_length=40),
                      keep_default=False)
    ...
    models = {
        ...
        u'blog.blogpost': {
            'Meta': {'ordering': "['-post_datetime']", 'object_name': 'BlogPost'},
